...
//+kubebuilder:webhook:path=/mutate-apps-mgxian-dev-v1-application,mutating=true,failurePolicy=fail,sideEffects=None,groups=apps.mgxian.dev,resources=applications,verbs=create;update,versions=v1,name=mapplication.kb.io,admissionReviewVersions=v1
...
func (r *Application) Default() {
	...
	if r.Spec.Replica == nil {
		applicationlog.Info("The spec.replica is nil,Set default value to 2")
...
//+kubebuilder:webhook:path=/validate-apps-mgxian-dev-v1-application,mutating=false,failurePolicy=fail,sideEffects=None,groups=apps.mgxian.dev,resources=applications,verbs=create;update,versions=v1,name=vapplication.kb.io,admissionReviewVersions=v1
...
func (r *Application) ValidateVerification() error {
	...
	return apierrors.NewInvalid(
		schema.GroupKind{Group: "apps.mgxian.dev", Kind: "Application"},
		r.Name, allErrs)
}
